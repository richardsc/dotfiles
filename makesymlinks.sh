...
files="emacs emacs-gnu.el emacs.d/custom.el emacs.d/org-cgr.el profile Rprofile gitconfig latexmkrc  notarc bm-repository octaverc"    # list of files/folders to symlink in homedir
