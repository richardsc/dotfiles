...
files="emacs emacs-gnu.el emacs.d/custom.el emacs.d/org-cgr.el profile Rprofile gitconfig latexmkrc nbrc bm-repository octaverc"    # list of files/folders to symlink in homedir
...
binfiles="bashmarks.sh displayreadme ipadsync markdown mterm rterm tree v t.py matlabcmd"
