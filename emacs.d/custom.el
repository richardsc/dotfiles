(custom-set-variables
 ...
 '(package-selected-packages
   '(impatient-mode simple-httpd use-package ess julia-mode exec-path-from-shell pandoc-mode company-reftex company-bibtex company-auctex company poly-R poly-markdown poly-noweb poly-org zenburn-theme undo-tree sublimity powerline polymode matlab-mode markdown-mode lorem-ipsum ido-vertical-mode highlight-current-line bm auctex ac-octave ac-math))
 '(show-paren-mode t)
