(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (poly-R poly-markdown poly-noweb poly-org zenburn-theme undo-tree sublimity powerline polymode matlab-mode markdown-mode lorem-ipsum ido-vertical-mode highlight-current-line ess bm auctex ac-octave ac-math)))
 '(show-paren-mode t)
